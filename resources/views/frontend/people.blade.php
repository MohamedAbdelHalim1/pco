...
<body>
    ...
    <header>
        ...
        <div class="row">
            <div class="col-xl-12">
                <img src="assets/images/people.png" class="sub-banner">
            </div>
            ...
            <div class="row justify-content-center">
                <div class="col-xl-3 p-4">
                    <div class="card rounded-0 border-0">
                        <img src="assets/images/Rogina khaled.jpg" class="card-img-top rounded-0 p-2" alt="...">
                        <div class="card-body text-center">
                            <h5 class="card-title">Rogina khaled</h5>
                            <p class="card-text">CEO</p>
                            <div class="d-flex justify-content-center">
                                <div class="info-social w-100 ">
                                    <div class="d-flex justify-content-center">
                                        <span class="me-2">
                                            <a href="">
                                                <i class="fa-brands fa-facebook-f text-dark border border-2 p-1"></i>
                                            </a>
                                        </span>
                                        <span class="me-2">
                                            <a href=""
                                            >
                                                <i class="fa-brands fa-instagram text-dark border border-2 p-1"></i>
                                            </a>
                                        </span>
                                        <span class="me-2">
                                            <a href=""
                                            >
                                                <i class="fa-brands fa-linkedin-in text-dark border border-2 p-1"></i>
                                            </a>
                                        </span>
                                        <span class="me-2">
                                            <a href="">
                                                <i class="fa-brands fa-whatsapp  text-dark border border-2 p-1"></i>
                                            </a>
                                        </span>
                                        <span class="me-2">
                                            <a href=""
                ...
                <div class="col-xl-3 p-4">
                    <div class="card rounded-0 border-0">
                        <img src="assets/images/Mohamed Masoud.jpg" class="card-img-top rounded-0 p-2" alt="...">
                ...
                <div class="col-xl-3 p-4">
                    <div class="card rounded-0 border-0">
                        <img src="assets/images/Afaf.jpg" class="card-img-top rounded-0 p-2" alt="...">
                        <div class="card-body text-center">
                ...
                <div class="col-xl-3 p-4">
                    <div class="card rounded-0 border-0">
                        <img src="assets/images/Mostafa Morsi.jpg" class="card-img-top rounded-0 p-2" alt="...">
                        <div class="card-body text-center">
                ...
                <div class="col-xl-3 p-4">
                    <div class="card rounded-0 border-0">
                        <img src="assets/images/Yomna sharaf.jpg" class="card-img-top rounded-0 p-2" alt="...">
                        <div class="card-body text-center text-center">
                            <h5 class="card-title">Yomna sharaf</h5>
                            <p class="card-text">CEO</p>
                            <div class="d-flex justify-content-center">
                                <div class="info-social w-100 ">
                                    <div class="d-flex justify-content-center">
                ...
                <div class="col-xl-3 p-4">
                    <div class="card rounded-0 border-0">
                        <img src="assets/images/Mohamed Abas.jpg" class="card-img-top rounded-0 p-2" alt="...">

                        <div class="card-body text-center text-center">
                            <h5 class="card-title">Mohamed Abas</h5>
                            <p class="card-text">project manager</p>
                            <div class="d-flex justify-content-center">
                                <div class="info-social w-100 ">
                                    <div class="d-flex justify-content-center">
                ...
                <div class="col-xl-3 p-4">
                    <div class="card rounded-0 border-0">
                        <img src="assets/images/Marina ragaai.jpg" class="card-img-top rounded-0 p-2" alt="...">
                        <div class="card-body text-center">
                            <h5 class="card-title">Marina ragaai</h5>
                            <p class="card-text">Head Of Business Development</p>
                            <div class="d-flex justify-content-center">
                                <div class="info-social w-100 ">
                                    <div class="d-flex justify-content-center">
                ...
                <div class="col-xl-3 p-4">
                    <div class="card rounded-0 border-0">
                        <img src="assets/images/Mahmoud gebril.jpg" class="card-img-top rounded-0 p-2" alt="...">
                        <div class="card-body text-center">
                            <h5 class="card-title">Mahmoud gebril</h5>
                            <p class="card-text">project manager</p>
                            <div class="d-flex justify-content-center">
                                <div class="info-social w-100 ">
                                    <div class="d-flex justify-content-center">
