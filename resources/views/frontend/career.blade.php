...
<body>
    ...
    <header>
        ...
        <div class="row">
            <div class="col-xl-12">
                <img src="assets/images/career.png" class="sub-banner">
            </div>
        </div>
    </header>
            ...
            <div class="row justify-content-center mb-3">
                ...
                <div class="col-xl-6">
                    <p class="text-center">
                        ...
                        bet on people, not on strategies. So to join our team, please review the below vacancies and
                        apply online.
                    </p>
                </div>
            </div>
            <div class="row justify-content-center">
                <div class="col-xl-3 me-3 bg-white rounded-2 p-3 box-job mb-4">
                    <small>12-6-2024</small>
                    <h5>Interior Designer Engineer</h5>
                    <p class="des-job">
                        2-3 years of experience. - Architecture Engineering Graduates/fine arts /applied art.
                    </p>
                </div>
                <div class="col-xl-3 me-3 bg-white rounded-2 p-3 box-job mb-4">
                    <small>12-6-2024</small>
    ...
    <section class="mt-xl-5 apply-form">
        <div class="container">
            <div class="row justify-content-start">
                <div class="col-xl-8">
                    ...
                    <p>
                        Or you can send your cv and we will contact you if we have a free position to hoin us.
                    </p>
                </div>
            </div>
            <div class="row justify-content-center mb-5">
                <div class="col-xl-6 my-auto">
                    <form>
                        ...
                        <div class="mb-3 form-input ">
                            <input type="text" class="form-control" placeholder="Phone*" id="exampleInputEmail1"
                                aria-describedby="emailHelp">
                        </div>
                        <div class="mb-3 form-input ">
                            <input type="text" class="form-control" placeholder="preferred position*"
                ...
                <div class="col-xl-5">
                    <img src="assets/images/career.jpg" style="width: 100%;">
                </div>
            </div>
        </div>
    </section>
