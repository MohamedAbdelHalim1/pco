...
<body>
    ...
    <section class="blogs">
        <div class="container pc">
            <div class="row justify-content-around">
                <div class="col-xl-5 sec-blog">
                    <div class="blog">
                        <div class="image-container">
                            <img src="assets/images/news-22-370x272.jpg" class="image-blog">
                            <div class="overlay"></div>
                        </div>
                        <div class="blog-info rounded-0">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item" aria-current="page">By: admin
                                    </li>
                                    <li class="breadcrumb-item" aria-current="page">wooden
                                        projects</li>
                                    <li class="breadcrumb-item" aria-current="page">comments: 0
                                    </li>
                                </ol>
                            </nav>
                            <h4>
                            ...
                            <p>
                                Together objective at homelane is to bring together our visitor's societies and spirits
                                with our own, communicating enthusiasm and liberality in the…
                            </p>
                            <div class="d-flex justify-content-start">
                                <div>
                                    <a href="{{route('blog.details')}}" class="btn button-more">
                                        read more
                                    </a>
                                </div>
                                <div>
                                    <i class="fa-solid fa-arrow-right-long text-secondary fw-bolder"></i>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-xl-5 sec-blog">
                    <div class="blog">
                        <div class="image-container">
                            <div class="overlay"></div>
                            <img src="assets/images/news-23-370x272.jpg" class="image-blog">
                            <div class="overlay"></div>
                        </div>
                        <div class="blog-info rounded-0">
                            <nav aria-label="breadcrumb">
        ...
        <div class="container mob">
            <div class="row justify-content-center">
                <div class="col-12 mb-4">
                    <div class="card">
                        <img src="assets/images/news-22-370x272.jpg" class="card-img-top">
                        <div class="card-body">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item" aria-current="page">By: admin
                ...
                <div class="col-12 mb-4">
                    <div class="card">
                        <img src="assets/images/news-23-370x272.jpg" class="card-img-top">
                        <div class="card-body">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item" aria-current="page">By: admin
