...
<body>
    ...
    <header>
        ...
        <div class="row">
            <div class="col-xl-12">
                <img src="assets/images/projects.png" class="sub-banner">
            </div>
            ...
            <div class="row justify-content-start mb-5">
                <div class="col-xl-8">
                    ...
                    <p>
                        ...
                        day, going forward, a new normal that has evolved from generation . Bring to the table win-win
                        survival strategies to ensure proactive domination.
                    </p>
                </div>
            </div>
            <div class="row justify-content-start mb-5">
                <div class="col-xl-4 col-lg-4 col-md-4 rounded-1 mb-4">                    
                    <div class="overlay-project rounded-1">
                        <img src="assets/images/projects/AGORA.jpg" class="rounded-1">
                        <div class="overlay rounded-1"></div>
                        <div class="boxes">
                            <ul>
                                <li>
                ...
                <div class="col-xl-4 col-lg-4 col-md-4 rounded-1 mb-4">
                    <div class="overlay-project rounded-1">
                        <img src="assets/images/projects/AIR-FORCE-HOSPITAL-MONORAIL-STATION.jpg" class="rounded-1">
                        <div class="overlay rounded-1"></div>
                        <div class="boxes">
                            <ul>
                    ...
                    <p class="text">
                        Where opulence meets function
                    </p>
                </div>
                <div class="col-xl-4 col-lg-4 col-md-4 rounded-1 mb-4">
                    <div class="overlay-project rounded-1">
                        <img src="assets/images/projects/AMAM-Villas-(Dorat-Al-Aros).jpg" class="rounded-1">
                        <div class="overlay rounded-1"></div>
                        <div class="boxes">
                            <ul>
                ...
                <div class="col-xl-4 col-lg-4 col-md-4 rounded-1 mb-4">
                    <div class="overlay-project rounded-1">
                        <img src="assets/images/projects/BA-Samah-Villas.jpg" class="rounded-1">
                        <div class="overlay rounded-1"></div>                     
                        <div class="boxes">
                            <ul>
                    ...
                    <p class="text">
                        the art of making space not just livable
                    </p>
                </div>
                <div class="col-xl-4 col-lg-4 col-md-4 rounded-1 mb-4">
                    <div class="overlay-project rounded-1">
                        <img src="assets/images/projects/Grand-Residance.jpg" class="rounded-1">
                        <div class="overlay rounded-1"></div>
                        <div class="boxes">
                            <ul>
                ...
                <div class="col-xl-4 col-lg-4 col-md-4 rounded-1 mb-4">
                    <div class="overlay-project rounded-1">
                        <img src="assets/images/projects/l'avenir-club-house.jpg" class="rounded-1">
                        <div class="overlay rounded-1"></div>
                        <div class="boxes">
                            <ul>
                    ...
                    <p class="text">
                        Simplicity transformed into splendor
                    </p>
                </div>
                <div class="col-xl-4 col-lg-4 col-md-4 rounded-1 mb-4">
                    <div class="overlay-project rounded-1">
                        <img src="assets/images/projects/Misr-El-Mahrosa--Watanya-0.jpg" class="rounded-1">
                        <div class="overlay rounded-1"></div>
                        <div class="boxes">
                            <ul>
                    ...
                    <h3>
                        Monorail Station One Ninety
                    </h3>
                    <p class="text">
                        A sanctuary of grace and style
                    </p>
                </div>
                <div class="col-xl-4 col-lg-4 col-md-4 rounded-1 mb-4">
                    <div class="overlay-project rounded-1">
                        <img src="assets/images/projects/Three-Sixty-LMD.jpg" class="rounded-1">
                        <div class="overlay rounded-1"></div>
                        <div class="boxes">
                            <ul>
                                
                                <li>
                                    <a href="{{route('project.details')}}" class="text-decoration-none">
                                        <i class="fa-solid fa-link"></i>
                                    </a>
                                </li>
                            </ul>
                    ...
                    <p class="text">
                        A well-designed space is more than luxury
                    </p>
                </div>
            </div>
        </div>
